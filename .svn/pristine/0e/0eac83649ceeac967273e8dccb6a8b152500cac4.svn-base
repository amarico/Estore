				...
				<div class="guidecontent">
					<div class="personcenter">
					  ...
					  <%
					   ...
					   <form action="<%=path%>/users/Users_changeEmail.action" method="post">
					   
					 <span>原来邮箱:</span>  <input type="text" name="oldEmail"/>
					 <br/>
					 <span>现在邮箱:</span>  <input type="text" name="newEmail"/>
					 <br/>
					 <span>确认邮箱:</span>   <input type="text" name="checkEmail"/>
